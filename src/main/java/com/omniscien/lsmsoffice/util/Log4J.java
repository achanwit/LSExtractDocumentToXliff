...
//				logPath = "/var/www/logs/lse-logs/msoffice/logs/";
	...
	public void debug(String message) throws Exception {
		try {
			if (message != null) {
				String sFileName = "msoffice-" + getFileName("yyyyMMdd-HH") + "-debug.txt";
	...
	public void info(String message) throws Exception {
		try {
			if (message != null) {
				String sFileName = "msoffice-" + getFileName("yyyyMMdd-HH") + "-info.txt";
	...
	public void warn(String message) throws Exception {
		try {
			if (message != null) {
				String sFileName = "msoffice-" + getFileName("yyyyMMdd-HH") + "-warn.txt";
	...
	public void error(String message) throws Exception {
		try {
			if (message != null) {
				String sFileName = "msoffice-" + getFileName("yyyyMMdd-HH") + "-error.txt";
...
//				String sFileName = "error-" + getFileName("yyyyMMdd-HH") + ".txt";
	...
	public void fatal(String message) throws Exception {
		try {
			if (message != null) {
				String sFileName = "msoffice-" + getFileName("yyyyMMdd-HH") + "-fatal.txt";
